...
- **Overwriting user customizations** — An update replaces reference files or reference/authoring/authoring-style.md wholesale, wiping user additions.
...
- **Incomplete partial updates** — A partial update (e.g., SKILL.md only) accidentally modifies reference files or templates.
