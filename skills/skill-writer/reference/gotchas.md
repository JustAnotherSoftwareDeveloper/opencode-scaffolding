...
- **Overwriting user customizations** — An update replaces reference files or style-guide.md wholesale, wiping user additions. Fix: Use targeted edits. Only modify sections the request targets. Preserve frontmatter, structure, and prose outside the edit scope.
