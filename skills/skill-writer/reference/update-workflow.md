...
- When updating `SKILL.md`, do not rewrite reference files under `reference/` or `style-guide.md` unless they are listed as targets.
...
- **SKILL.md only** — Update procedure, quality rules, validation checklist. Leave reference files and style-guide.md untouched.
...
- Preserve user customizations in reference/ files and style-guide.md when updating SKILL.md.
...
- **Request targets only SKILL.md procedure or structure?** → Edit SKILL.md only. Do not touch reference files, style-guide.md, or templates.
